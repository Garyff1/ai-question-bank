...
| Android v1.0.2 APK | [下载 APK](https://github.com/Garyff1/ai-question-bank/releases/download/android-v1.0.2/ai-question-bank-android-v1.0.2.apk) |
| Android v1.0.2 Release | [查看 Release](https://github.com/Garyff1/ai-question-bank/releases/tag/android-v1.0.2) |
| 部署说明 | [DEPLOYMENT.md](DEPLOYMENT.md) |

Android v1.0.2 APK 校验值：
...
1. 在安卓手机或平板上下载 [ai-question-bank-android-v1.0.2.apk](https://github.com/Garyff1/ai-question-bank/releases/download/android-v1.0.2/ai-question-bank-android-v1.0.2.apk)。
2. 打开 APK 安装包。
